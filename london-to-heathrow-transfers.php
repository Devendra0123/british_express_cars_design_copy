...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9645_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">London to Heathrow Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Transfer from
                                London to Heathrow</span></strong></h2>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #e50914;"><br></span></p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer to/from London
                            to Heathrow Airport. At British Express Cars we provide high-quality licensed private
                            airport transfer services between London and Heathrow. We operate 24 hours a day 7 days a
                            week. Our aim is to offer the best reliable and safest transfer service to all our customers
                            at a competitive price. Passengers can pre-book their London to Heathrow transfer service
                            online at fixed prices Instantly using our secure booking system.</span></p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><br></span></p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><span
                                style="font-family: arial, helvetica, sans-serif;">Our private transfer service from
                                London to Heathrow Airport or from Heathrow airport to London is available 7 days a
                                week, 365 days a year. The journey time for the transfer is approximately one hour and
                                10 minutes. However, during rush hours, traffic could add an extra 30 minutes to the
                                trip.</span></span></p>
                </div>

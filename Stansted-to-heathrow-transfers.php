...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9662_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Stansted to Heathrow Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Transfer from Stansted Airport to
                                    Heathrow Airport</span></strong></span></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer from Stansted
                            Airport to Heathrow Airport. At British Express Cars we provide high-quality licensed
                            private airport transfer services between Stansted Airport and Heathrow Airport. We operate
                            24 hours a day 7 days a week. Our aim is to offer the best reliable and safest transfer
                            service to all our customers at a competitive price. Passengers can pre-book their Stansted
                    ...
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Our private transfer
                            service from Stansted Airport to Heathrow Airport or from&nbsp; Heathrow Airport to Stansted
                            Airport is available 7 days a week, 365 days a year. The journey time for the transfer is
                            approximately 1 hour and 10 minutes. However, during rush hours, traffic could add an extra
                            30 minutes to the trip. Journey distance for the transfer is 62 mi (99 km).</span></p>
                </div>

<section style="" class="app_download_section2">
    <div class="app_download_section_container2">
        <div style="" class="desc_section2">
            ...
            <div style="display: flex; align-items:center; gap: 30px">
                ...
                <img style="width: 150px; height: 60px; object-fit: contain" src="./assets/images/App_Store_Icon.webp"
                    alt="play-store">
            </div>
        </div>

        <div class="app_image_container2">
            <img src="./assets/images/hand_with_phone.webp" alt="app_image" class="app_image">
        </div>
    </div>
</section>
...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9656_blog_cruise-transfers.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Transfer from Heathrow to Southampton </h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong>Transfer from Heathrow to Southampton</strong></span></h2>
                    <p>&nbsp;</p>
                    <p><span style="color: #444444;">Taxi to/from Heathrow to Southampton. At British Express Cars we
                            provide high-quality licensed private transfer services between Heathrow and Southampton. We
                            operate 24 hours a day 7 days a week. Our aim is to offer the best reliable and safest taxi
                            service to all our customers at a competitive price. Passengers can pre-book their Heathrow
                            to Southampton Taxi service online at fixed prices Instantly using our secure booking
                            system.</span></p>
                    <p>&nbsp;</p>
                    <p><span style="color: #444444;">Our private transfer service from <span>Heathrow to
                                Southampton</span> or from Southampton to Heathrow is available 7 days a week, 365 days
                            a year. The journey time for the transfer is approximately one hour and 5 minutes. However,
                            during rush hours, traffic could add an extra 30 minutes to the trip.&nbsp;<span>Journey
                                distance for the transfer is 61 mi (98 km).</span></span></p>
                </div>

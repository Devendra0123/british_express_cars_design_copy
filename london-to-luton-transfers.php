...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9648_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">London to Luton Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Transfer
                                to/from Luton Airport to London</span></strong></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer to/from London
                            to Luton Airport? At British Express Cars we provide high-quality licensed private airport
                            transfer services between London and Luton. We operate 24 hours a day 7 days a week. Our aim
                            is to offer the best reliable and safest transfer service to all our customers at a
                            competitive price. Passengers can pre-book their London to Luton Transfer service online at
                            fixed prices Instantly using our secure booking system.</span></p>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><span>Our private
                                transfer service from London to Luton Airport or from Luton airport to London is
                                available 7 days a week, 365 days a year. The journey time for the transfer is
                                approximately one hour and 10 minutes. However, during rush hours, traffic could add an
                                extra 30 minutes to the trip.</span><br></span></p>
                </div>

...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9661_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Heathrow to Stansted Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong><span
                                    ...
                                    Stansted Airport</span></strong></span></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer from Heathrow
                            Airport to Stansted Airport. At British Express Cars we provide high-quality licensed
                            private airport transfer services between Heathrow Airport and Stansted Airport. We operate
                            ...
                            to Stansted Transfer service online at fixed prices Instantly using our secure booking
                            system.</span></p>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">&nbsp;Our private
                            transfer service from Heathrow Airport to Stansted Airport or from Stansted Airport to
                            Heathrow Airport is available 7 days a week, 365 days a year. The journey time for the
                            transfer is approximately 1 hour and 10 minutes. However, during rush hours, traffic could
                            add an extra 30 minutes to the trip. Journey distance for the transfer is 62 mi (99
                            km).</span></p>
                </div>

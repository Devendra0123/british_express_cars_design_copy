...
<head>
    ...
    <title>Stansted Airport Transfers – British Express Cars </title>

    <meta name="title" content="Stansted Airport Transfers – British Express Cars ">

    <meta name="description"
        content="Licensed taxi transfers to and from Stansted Airport, our service available 24 hours a day, 7 days a week. Click here now to book your taxi">

    <meta name="keywords"
        content="stansted airport taxi, stansted airport taxi quote, taxi from stansted to london price, taxi to stansted, taxi to stansted airport.">
...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/80_blog_stansted.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Stansted Airport Transfers from £49.00 Only</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="font-family: arial, helvetica, sans-serif;"><strong><span
                                    style="color: #e50914;">London Stansted Airport Transfers</span></strong></span>
                    </h2>
                    <p><br><span style="color: #444444; font-family: arial, helvetica, sans-serif;">British Express
                            Cars. provides high-quality licensed private airport transfer services to and from Stansted
                            Airport. We operate 24 hours a day 7 days a week. Our aim is to offer the best reliable and
                            safest transfer service to all our customers at a competitive price. Passengers can pre-book
                            their Stansted Airport Transfer service online at fixed prices Instantly using our secure
                            booking system.</span></p>
                    <h3><br><span style="font-family: arial, helvetica, sans-serif;"><strong><span
                                    style="color: #e50914;">Stansted Airport Meeting Point</span></strong></span></h3>
                    <p><br><span style="color: #444444; font-family: arial, helvetica, sans-serif;">Main Terminal –
                            Outside Airport Information Desk</span></p>
                </div>

...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9657_blog_cruise-transfers.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Taxi from Southampton to Heathrow </h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="font-family: arial, helvetica, sans-serif;"><strong><span
                                    style="color: #e50914;">Taxi from Southampton to Heathrow</span></strong></span>
                    </h2>
                    <p><br><span style="font-family: arial, helvetica, sans-serif;">Taxi to/from Southampton to
                            Heathrow. At British Express Cars we provide high-quality licensed private transfer services
                            between Southampton and Heathrow. We operate 24 hours a day 7 days a week. Our aim is to
                            offer the best reliable and safest taxi service to all our customers at a competitive price.
                            Passengers can pre-book their Southampton to Heathrow Taxi service online at fixed prices
                    ...
                    <p><br><span style="font-family: arial, helvetica, sans-serif;">Our private transfer service from
                            Southampton to Heathrow or from Heathrow to Southampton is available 7 days a week, 365 days

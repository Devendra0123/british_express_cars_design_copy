            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Heathrow to Reading</h1>
                    </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="container">
        <div class="heading" style="margin-bottom:4em;">
            ...
            <h2 style="text-align: left;"><span
                    style="font-family: arial, helvetica, sans-serif; color: #dc3545;"><strong>Transfer from
                    </strong><strong>Heathrow</strong><strong> to </strong><strong>Reading</strong></span></h2>
            <p style="text-align: left;">&nbsp;</p>
            <p style="text-align: left;"><span
                    style="font-family: arial, helvetica, sans-serif; color: #444444;">Looking for a reliable Heathrow
                    to Reading transfer? At British Express Cars we provide high-quality licensed private airport
                    transfer service between Heathrow to Reading. Take advantage of our great prices which also include
                    all airport services: flight monitoring, meet &amp; greet (driver will wait at arrivals with a name
                    board) and 30 minutes free waiting time.</span></p>
            <p style="text-align: left;"><span
            ...
            <p style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif; color: #444444;">We
                    ...
                    service to all our customers at a competitive price. Passengers can pre-book their Heathrow to
                    Reading Transfer service online at fixed prices Instantly using our secure booking system.</span>
            </p>
            <p></p>

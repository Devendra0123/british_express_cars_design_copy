...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9646_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">London to Gatwick Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="color: #e50914;">Transfer from London to Gatwick</span></strong></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer to/from London
                            to Gatwick Airport. At British Express Cars we provide high-quality licensed private airport
                            transfer services between London and Gatwick. We operate 24 hours a day 7 days a week. Our
                    ...
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><span>Our private
                                transfer service from London to Gatwick Airport or from&nbsp; Gatwick Airport to London
                                is available 7 days a week, 365 days a year. The journey time for the transfer is
                                approximately one hour and 120 minutes. However, during rush hours, traffic could add an

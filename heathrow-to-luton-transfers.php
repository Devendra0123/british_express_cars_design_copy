...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9664_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Heathrow to Luton Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Transfer from Heathrow Airport to
                                    Luton Airport</span></strong></span></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer from Heathrow
                            Airport to Luton Airport. At British Express Cars we provide high-quality licensed private
                            airport transfer services between Heathrow Airport and Luton Airport. We operate 24 hours a
                            day 7 days a week. Our aim is to offer the best reliable and safest transfer service to all
                            our customers at a competitive price. Passengers can pre-book their Heathrow to Luton
                            Transfer service online at fixed prices Instantly using our secure booking
                            system.&nbsp;</span></p>
                    <p>&nbsp;</p>
                    <p><span style="color: #444444; font-family: arial, helvetica, sans-serif;">Our private transfer
                            service from Heathrow Airport to Luton Airport or from Luton Airport to Heathrow Airport is
                            available 7 days a week, 365 days a year. The journey time for the transfer is approximately
                            40 minutes to an hour. However, during rush hours, traffic could add an extra 30 minutes to
                            the trip. Journey distance for the transfer is 34 mi (54 km).</span></p>
                </div>

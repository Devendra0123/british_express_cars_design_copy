...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9653_blog_cruise-transfers.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Dover Cruise Transfers </h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Dover Cruise
                                Port Transfers</span></strong></h2>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">At British Express Cars.
                            We provide high-quality licensed private cruise transfer services to and from Dover. We
                            operate 24 hours a day 7 days a week. Our aim is to offer the best reliable and safest
                            transfer service to all our customers at a competitive price. Passengers can pre-book their
                            Dover Cruise Taxi Transfer service online at fixed prices Instantly using our secure booking
                            system.</span></p>
                    <h3><br><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Overview Of
                                Dover Seaport&nbsp;</span></strong></h3>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><br></span></p>
                    <p><span style="font-family: arial, helvetica, sans-serif;"><span style="color: #444444;">The Port
                                of Dover is the cross-channel port situated in Dover, Kent, s</span>outh-east England.
                            It is the nearest English port to France, at just 34 kilometres (21 mi) away, and is one of
                            the world's busiest passenger ports, with 11.7 million passengers, 2.6 million lorries, 2.2
                            million cars and motorcycles and 80,000 coaches passing through it in 2017.</span></p>
                </div>

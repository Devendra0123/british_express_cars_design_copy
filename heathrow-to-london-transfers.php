...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9650_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Transfer from Heathrow to London</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Transfer from Heathrow to
                                    London</span></strong></span></h2>
                    <p><strong><span
                                style="font-family: arial, helvetica, sans-serif; color: #0066d9;"><br></span></strong>
                    </p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Taxi to/from Heathrow to
                            London. At Chelsea Airport Cars we provide high-quality licensed private airport transfer
                            services between Heathrow and London. We operate 24 hours a day 7 days a week. Our aim is to
                            offer the best reliable and safest taxi service to all our customers at a competitive price.
                            Passengers can pre-book their London to Heathrow Taxi service online at fixed prices
                            Instantly using our secure booking system.</span></p>
                    <p><br><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Our private transfer
                            service from Heathrow Airport to London or from London to Heathrow Airport is available 7
                            days a week, 365 days a year. The journey time for the transfer is approximately 50 minutes
                            to an hour. However, during rush hours, traffic could add an extra 30 minutes to the trip.
                            Journey distance for the transfer is 18 mi (28 km).</span></p>
                </div>

            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Portsmouth Cruise Transfers </h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="color: #e50914;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Portsmouth Cruise Port
                                    Transfers</span></strong></span></h2>
                    <p><span style="color: #e50914;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;"><br></span></strong></span></p>
                    <p><span style="color: #444444; font-family: arial, helvetica, sans-serif;">We offer private
                            transportation service to/from Portsmouth Cruise Port at competitive and affordable rates.
                            Book online in minutes and save up to 40% compared to other companies.</span></p>
                    <p>&nbsp;</p>
                    <h3><span style="font-family: arial, helvetica, sans-serif;">Overview Of Portsmouth Seaport</span>
                    </h3>
                    <p>&nbsp;</p>
                    <p><span style="color: #444444; font-family: arial, helvetica, sans-serif;">Portsmouth is the
                            homeport of the British Royal Navy, having here around 3/4 of UK's fleet. Here is also
                            homeported UK's new aircraft carrier HMS Queen Elizabeth (supercarrier project R08). You can
                            read an extensive review of the navy vessel at QueenElizabethCruises.net. UK's ever largest
                            aircraft carrier (building cost GBP 3 billion) docked at Portsmouth's naval base on August
                            16, 2017.&nbsp;The warship arrived from the Rosyth dockyard where was constructed. By a GBP
                            100 million contract were redeveloped naval port's facilities in order to be able to support
                            both aircraft carriers - HMS Queen Elizabeth and the sistership HMS Prince of Wales.</span>
                    </p>
                </div>

...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9651_blog_cruise-transfers.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">Southampton Cruise Transfers </h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Southampton
                                Cruise Port Transfers</span></strong></h2>
                    <p><strong><span
                                style="font-family: arial, helvetica, sans-serif; color: #e50914;"><br></span></strong>
                    </p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">We offer private
                            transportation service to/from Southampton Cruise Port at competitive and affordable rates.
                            Book online in minutes and save up to 40% compared to other companies.</span></p>
                    <p>&nbsp;</p>
                    <h3><strong><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Overview Of
                                Southampton Seaport</span></strong></h3>
                    <p><strong><span
                                style="font-family: arial, helvetica, sans-serif; color: #e50914;"><br></span></strong>
                    </p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Southampton is the UK's
                            number one vehicle handling port, handling 900,000 vehicles per year. It is also Europe's
                            leading turnaround cruise port, welcoming around 2 million passengers annually and is home
                            to the UK fleets of the largest cruise line operators in the world. It is also home to the
                            second largest container terminal in the UK and in 2019 handled more than 1.9 million
                            TEUs.&nbsp;</span></p>
                    <p>&nbsp;</p>
                    <h3><span style="color: #444444;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Transportation to/from
                                    Southampton Port</span></strong></span></h3>
                    <p>&nbsp;</p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">The Port of Southampton
                            is less than two miles (3km) from the M27 and has direct rail links to the national railway
                            network for both freight and passengers. The port offers 23 container trains a day with
                            gauge clearance for 9'6" high containers to major cargo-generating regions in the Midlands,
                            North West, East Coast, and Scotland.The port is served by Southampton International
                            Airport, while Gatwick and Heathrow airports are within easy reach.</span></p>
                </div>

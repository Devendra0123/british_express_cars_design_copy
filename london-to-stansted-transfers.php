...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9647_blog_london.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">London to Stansted Transfers</h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><span style="font-family: arial, helvetica, sans-serif; color: #e50914;">Transfer from London to
                            Stansted</span></h2>
                    <p><span style="font-family: arial, helvetica, sans-serif;"><br></span></p>
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Transfer to/from London
                            to Stansted Airport. At British Express Cars we provide high-quality licensed private
                            airport transfer services between London and Stansted. We operate 24 hours a day 7 days a
                            week. Our aim is to offer the best reliable and safest transfer service to all our customers
                            at a competitive price. Passengers can pre-book their London to Stansted Transfer service
                    ...
                    <p><span style="font-family: arial, helvetica, sans-serif; color: #444444;"><span>Our private
                                transfer service from London to Stansted Airport or from Stansted airport to London is

...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/9654_blog_cruise-transfers.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">London Cruise Transfers </h1>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="term-wrap">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2><strong><span style="color: #e50914; font-family: arial, helvetica, sans-serif;">London Cruise
                                Transfers</span></strong></h2>
                    <p><br><span style="font-family: arial, helvetica, sans-serif; color: #444444;">Looking for a
                            reliable London Cruise Transfers? At British Express Cars we provide high-quality licensed
                            private cruise transfer services to and from Southampton, Dover, Harwich, Portsmouth and
                            Tilbury Cruise Terminals to any part of the United Kingdom. We operate 24 hours a day 7 days
                            a week. Our aim is to offer the best reliable and safest transfer service to all our
                            customers at a competitive price. Passengers can pre-book their London Cruise Transfer

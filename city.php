...
<section class="banner">
    <div class="main-banner one"
        style="background:url(https://www.britishexpresscars.co.uk/media/82_blog_london-city.jpg) no-repeat center top; ">
        <!--            <figure>-->
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="banner-content">
                        <h1 style="color: #fff">City Airport Transfers from £39.00 Only.</h1>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2 style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif;"><strong><span
                                    style="color: #e50914;">London City Airport Transfer Services</span></strong></span>
                    </h2>
                    <p style="text-align: left;"><br><span
                            style="color: #444444; font-family: arial, helvetica, sans-serif;">British Express Cars.
                            provides high-quality licensed private airport transfer services to and from City Airport.
                            ...
                            City Airport Transfer service online at fixed prices Instantly using our secure booking
                            system.</span></p>
                    <h3 style="text-align: left;"><br><span
                            style="font-family: arial, helvetica, sans-serif;"><strong><span
                                    style="color: #e50914;">City Airport Meeting
                                    Points&nbsp;&nbsp;</span></strong></span></h3>
                    <p><span style="color: #e50914; font-family: arial, helvetica, sans-serif;"><br></span></p>
                    <p style="text-align: left;"><span
                            style="color: #444444; font-family: arial, helvetica, sans-serif;">Main Terminal – Outside
                            Airport Information Desk.</span></p>
                </div>
